        ...
        <div class="clearfix"></div>
       	...
       	<!-- form input mask -->
	        ...
	        <!--Content-->
	        	...
	        	<div id="diagnosis" style="float:left; margin-top: 50px; width: 100%">
					<p style="font-size:20px; color:white; background: linear-gradient(to right, #d63031, white);
						height:30px; border-radius:8px;">&nbsp<b>Diagnosis</b></p>
					<textarea rows="7" class="form-control" placeholder="Enter diagnosis here"
						style="border-radius:12px; border: 1px solid gray; box-shadow:2px 3px; margin-left: 20px; width: 95%;"></textarea>
				</div>

				<div id="treatment-done" style="float:left; margin-top: 50px; width: 100%">
					<p style="font-size:20px; color:white; background: linear-gradient(to right, #d63031, white);
					...
					<textarea rows="7" class="form-control" placeholder="Enter treatment here"
						style="border-radius:12px; border: 1px solid gray; box-shadow:2px 3px; margin-left: 20px; margin-bottom: 30px; width: 95%;"></textarea>
				</div>
				...
				<div id="prescription" style="float: left; width:100%;">
					<button class="btn btn-success" style="margin-left: 35%">ADD</button>
					<button class="btn btn-success" style="margin-left: 48%">ADD</button>
				</div>
				...
				<div id="emergencyReferral" style="float: left; width:100%;">
					...
					<div style="float:left; margin-left:10px; font-size:18px; width:50px;">
						<select style="width:250px; border-radius:8px; margin-bottom:0px; 172px;height: 25px;">
					...
					<div style="float:left; margin-left:22%; width:50%;">
						...
						<input type="text" name="" style="width:350px; border-radius:8px; margin-bottom:12px;
							margin-left: 20px; height: 25px; font-size: 18px">
					</div>
					<div>
						<button class="btn btn-default" data-toggle="modal" data-target="#modalLabRefer"
							style="margin-left: 30px">Lab Referral
						</button>
					</div>
				</div>
				...
				<div style="margin-top: 25px;float: left;text-align: center;width: 100%">
					<button class="btn btn-success" data-toggle="modal" data-target="#modalPrint">SAVE
					</button>
...
<!-- MODAL -->
	<div id="modalPrint" class="modal fade" role="dialog">
        ...
        <!-- Modal content -->
            <div class="modal-content" style="background-color: #f7f1e3">
				<div>
					<h4 style="display: inline-block; margin-top:20px; margin-left: 35px;">Print emergency information?</h4>
				</div>
				<div class="modal-footer" style="margin-right:32%">
					<a href="{{ url('/physicianEmergency') }}"><button class="btn btn-success">YES</button></a>
					<a href="{{ url('/physicianEmergency') }}"><button class="btn btn-danger">NO</button></a>
				</div>
            </div>
        </div>
	</div>
...
<!-- MODAL -->
	<div id="modalLabRefer" class="modal fade" role="dialog">
    	<div class="modal-dialog" style="width:680px">
        <!-- Modal content -->
            <div class="modal-content" style="background-color: #f7f1e3">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss = "modal">&times;</button>
						<h4 class="modal-title">Laboratory Referral</h4>
				</div>
                
				<div class="modal-body" style="color:#192a56; font-size:15px;">
					
					<h4 style="width: 130px; margin-bottom:15px;">Request for: </h4>

					<label style="margin-right:15px;"><h5>Chest X-Ray</h5></label>
	                <input type="checkbox" name="" class="radio-past" style="margin-bottom:12px;"> PA
					...
					<textarea rows="4" class="form-control" style="border-radius:12px; border: 1px solid gray; box-shadow:2px 3px; margin-left: 20px; width: 95%;">
              </textarea>
				</div>
