                            ...
                            @foreach($diagnoses as $info)
                                <tr class="even pointer">
                                    ...
                                    <td class=" " style="width: 300px;">
                                        <a href="{{ route('mchief.view.history', ['id' => $info->patientID, 'clinicLogID' => $info->clinicLogID]) }}""><button
                                            class="btn btn-default" style="background-color:#218c74; color:white">View History</button>
                                        </a>
                                        <a href="{{ route('mchief.referred.patient.diagnoses', $info->patientID) }}"><button
