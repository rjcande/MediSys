        ...
        <!-- Modal content -->
            <div class="modal-content" style="background-color: #f7f1e3">
                ...
                <div class="med-cert" style="float: left; margin-left: 50px; width: 90%; background-color: #f5f6fa; margin-bottom: 40px;">
	        		...
	        		<header style="float: right; font-size: 18px; margin-top: 30px; text-align: right;margin-right: 10px;">Date _________________________</header>

	        		<header style="float: left; font-size: 18px; margin-top: 30px; margin-left: 40px;">To Whom It 		May Concern:</header>

	        		<header style="float: left; font-size: 18px; margin-top: 20px; margin-left: 40px; text-indent: 50px; margin-right: 10px;">This is to certify that _______________________________________________ has been examined by<br>the undersigned and found to be physically fit at the time of examination.</header>
	        		...
	        		<header style="float: right; font-size: 18px; margin-top: 40px; text-align: right;margin-right: 10px;">_________________________ M.D.</header>
	        		<header style="float: right; font-size: 18px;text-align: right; margin-right: 115px">Clinic Physician</header>
	        		<header style="float: right; font-size: 18px; margin-top: 20px; text-align: right; margin-right: 10px;">_______________________ Lic. No.</header>
	        	</div>
        ...
        <!-- Modal content -->
            <div class="modal-content" style="background-color: #f7f1e3">
                ...
                <div class="med-cert" style="float: left; margin-left: 50px; width: 90%; background-color: #f5f6fa; margin-bottom: 40px;">
	        		...
	        		<header style="float: left; font-size: 18px; margin-top: 20px; margin-left: 40px; text-indent: 50px; margin-right: 10px;">This is to certify that ______________________________________________________________________<br>has been examined by the undersigned at the PUP Medical Clinic on<input type="text" name="certAdminPurpose" style="display: inline; width: 370px;" required="">.</header>
        ...
        <!-- Modal content -->
            <div class="modal-content" style="background-color: #f7f1e3">
                ...
                <div class="med-cert" style="float: left; margin-left: 50px; width: 90%; background-color: #f5f6fa; margin-bottom: 40px;">
	        		...
	        		<header style="float: left; font-size: 18px; margin-top: 20px; margin-left: 40px; text-indent: 50px; margin-right: 10px;">This is to certify that ______________________________________________________________________<br>has been treated/is currently being treated for <input type="text" name="excuseReason" style="width: 200px;" required>
        ...
        <!-- Modal content -->
            <div class="modal-content" style="background-color: #f7f1e3">
                ...
                <div class="med-cert" style="float: left; margin-left: 50px; width: 90%; background-color: #f5f6fa; margin-bottom: 40px;">
	        		...
	        		<header style="float: left; font-size: 18px; margin-top: 20px; margin-left: 40px; text-indent: 50px; margin-right: 10px;">I, _________________________________________________________________ enrolled at the College of <input type="text" name="college" required> Department of <input type="text" name="department" required>, was seen and examined at the PUP Medical Clinic dated <u>{{ date('F m, Y') }}</u> with the diagnosis of <input type="text" name="diagnosis" required>. I promise to come back for a follow-up <br>check-up on <input type="date" name="followUp" required> as advised.</header>
...
<script>
	$(document).ready(function(){
	    ...
	    $('#btnDone').on('click', function(e){
	    	...
	    	$.ajax({
	    		url:'/physician/update/log/referrals/' + $(this).data('id'),
	    		type: 'get',
	    		data: {status: 2},
	    		success: function(){
	    			swal({
