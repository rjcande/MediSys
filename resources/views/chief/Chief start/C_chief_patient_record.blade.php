	        ...
	        <!--Content-->
	        	<div>
                    <table class="table table-striped table-bordered jambo_table bulk_action" id="patientTable">
                        ...
                        <tbody>
                            @foreach($consultInfos as $info)
                                @foreach($diagnoses as $diagnosed)
                                    @if($info->logReferralID == $diagnosed->logReferralID)
                                <tr class="even pointer">
                                    ...
                                    <td class=" " style="width: 300px;">
                                        ...
                                        <a href="{{ route('physician.referred.patient.diagnoses', $info->patientID) }}"><button
                                            class="btn btn-default" style="background-color:#33d9b2; color:white;">Consultations</button>
                                        </a>
