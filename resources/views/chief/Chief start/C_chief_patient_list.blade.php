                        ...
                        <tbody>
                          @foreach($patientList as $patient)
                            <tr class="even pointer">
                              ...
                              <td class=" last">
                                <a href="{{ route('chief.patient.more.info', $patient->patientID) }}">
                                  <button class="btn btn-info" data-toggle="tooltip" title="View More Info">
                                    View More
                                  </button>
                                </a>
                                <a href="{{ route('chief.patient.diagnoses', $patient->patientID) }}">
                                  <button type="button" class="btn btn-default" data-toggle="tooltip" title="Consultation">Consultation</button>
                                </a>
                              </td>
                            </tr> 
                          @endforeach 
