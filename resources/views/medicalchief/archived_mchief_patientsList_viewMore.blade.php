                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div>
                      ...
                      <div style="float: left;">
                        <input type="text" name="lastName" style="width:300px; border-radius:8px; margin-bottom:12px;" value="{{ $patientInfo->lastName }}" readonly>
                      </div>
                    </div>
                  ...
                  <div style="float: left; text-align:center; width: 100%; margin-top:30px;">
                    <a href="{{ url('/mchief/archived/patients') }}">
                      <button class="btn btn-primary">BACK</button>
                    </a>
                    <a href="{{ url('/mchief/archived/patients/viewMore/medicalLogs' , $patientInfo->patientID) }}">
