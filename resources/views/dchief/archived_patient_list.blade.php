                      ...
                      <tbody>
                        @foreach ($patient as $patients)
                          <tr class="even pointer">
                            ...
                            <td class=" ">
                              <a href="{{ url('/dchief/archived/patient/list/ViewMore', $patients->patientID) }}">
                                <button class='btn btn-info' type="submit" title='View More Info'>View More</button>
                              </a>

                              <a href="{{url('/dchief/archived/patient/list/concerns', $patients->patientID)}}">
                                <button class='btn btn-default' type="submit" title='View More Info'>Concerns</button>
                              </a>

                              <a href="{{ url('/dchief/restore/patient',$patients->patientID) }}"><button class='btn btn-success' type="button" title='Restore'><i class="fa fa-refresh"></i></button>
                            </td>
                          </tr>
                        @endforeach
                        </tbody>
...
<div class="modal fade" id="patientListModal" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <form id="printPatientList" action="{{route('dchief.generate.patientList')}}" target="_blank" method="get">
          @csrf()
