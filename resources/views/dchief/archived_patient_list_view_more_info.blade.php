        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Patient Personal Info  (Archived)</h3>
            </div>
          </div>
              ...
              <div class="x_panel">
                ...
                <!-- BUTTON DIV -->
                  <div style="float: left; text-align:center; width: 100%; margin-top:30px;">
                    <a href="{{ url('/dchief/archived/patient/list') }}">
                      <button class="btn btn-primary">BACK</button>
                    </a>
                    <a href="{{ url('/dchief/archived/patient/list/viewMore/dental/log/each', $patientInfo->patientID) }}">
