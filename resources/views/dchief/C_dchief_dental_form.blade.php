                           ...
                           <!--IF GENDER IS A WOMAN THEN ENABLED-->
                            <div style="float: left;width:100%; margin-left: 50px; font-size:15px; margin-top:10px;">
                              ...
                              <p style="font-size:17px; margin-left:50px;">Are you pregnant?
                                @if($patientGender['gender'] == 'F' || $patientGender['gender'] == 'f' || $patientGender['gender'] == 0)
                                ...
                                @elseif($patientGender['gender'] == 'M' || $patientGender['gender'] == 'm' || $patientGender['gender'] == 1)
    ...
    var btnFinish = $('<button></button>').text('Done')
                      ...
                      .on('click', function(e){
                        ...
                        if ($('#saveForm').parsley().isValid("first")) {
                            $.ajax({
                              url: '/dchief/dental/HistoryForm/store',
                              type: 'get',
                              ...
                              success: function(output){
                                ...
                                .then((willRoute)=>{
                                  if(willRoute){
                                    ...
                                    window.location.href = '/dchief/vital/signs/' + $('#saveForm').data('id');
                                  }
                                });
                              }
                            });
