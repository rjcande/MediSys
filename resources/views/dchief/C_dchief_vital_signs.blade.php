                  ...
                  <form id="saveForm">
                   ...
                   @endif>&nbsp Obese Class III
                    ...
                    <div style="float:left;text-align: center;width: 100%;">
                      ...
                      <a href="{{url('/dchief/DentalLog')}}"><button class="btn btn-danger" type="button">CLOSE</button></a>
                    </div>
                  </form>
                  <!-- /Content -->
                </div>
   ...
   $('#saveForm').submit(function(e){
    e.preventDefault();
      ...
      if($('#saveForm').parsley().isValid('vitalSign')){
        ...
        console.log(id);
        // alert( $('input[name=height]').val() + ' ' + $('#heightUnit').val())
        
        $.ajax({
          url: '/dchief/vital/store',
          type: 'get',
          ...
          success: function(output){
            ...
            .then((willRoute)=>{
              if(willRoute){
                window.location.href = "/dchief/dentalchart";
              }
            });
          }
        });
