                    ...
                    <table class="table table-striped table-bordered jambo_table bulk_action" style="width:100%" id="patientTable">
                      ...
                      <tbody>
                        ...
                        <tr class="even pointer">
                          ...
                          <td class=" ">
                            <a href="{{ route('dentist.dentalLog.moreInfo', $dentalLog->clinicLogID) }}">
...
<script>
  $(document).ready(function(){
    ...
    $('#patientNumber').autocomplete({
      serviceUrl:'/dentist/DentalForm/Autocomplete',
      paramName: 'input',
      minChars: 1,
      maxChars: 15,
  ...
  //Script for not clicking the edit button when the patient only asks for dental certificate
  // $.each($dentalLogs, $dentalLog)
  // {
  //   if($dentalLog->concern == 1){
