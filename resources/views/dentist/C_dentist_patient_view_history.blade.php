                ...
                <!-- Content -->
                  <div>
                    ...
                    <div style="margin-top: 25px;margin-bottom: 30px;float: left;text-align: center;width: 100%">
                      <a href="{{route('dentist.generate.dentalHistory', $patientInfo['patientID'])}}" target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-download"></i> GENERATE DENTAL HISTORY</button></a>
