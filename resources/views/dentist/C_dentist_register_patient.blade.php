            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  @endif
                  <form id="addPatientForm" action="{{route('dentist.add.patient')}}" method="post">
                    @csrf
                  ...
                  <div style="float: left; text-align:center; width: 100%; margin-top:30px;">
                    ...
                    <a href="{{ url('/dentist/PatientList') }}"><button class="btn btn-primary" type="button" >BACK</button></a>
                  </div>
