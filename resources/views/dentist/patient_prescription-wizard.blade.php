              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <!-- Content -->
                    <div id="smartwizard">
                        <ul>
                            <li><a href="#step-1">Step 1<br /><small>Symptoms and Treatments</small></a></li>
                            <li><a href="#step-2">Step 2<br /><small>Prescriptions</small></a></li>
                            <li><a href="#step-3">Step 3<br /><small>Outside Referrals(Optional)</small></a></li>
                        </ul>
                                                ...
                                                success: function(output){
                                                  ...
                                                  .then((willRoute)=>{
                                                    if(willRoute){
                                                      ...
                                                      // window.location.href = '/dentist/vital/signs';
                                                      window.location.href = '/dentist/vital/signs/' + $('#saveForm').data('id');
                                                    }
                                                  });
                                                }
                                              });
