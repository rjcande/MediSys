  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Dental Supplies Used Statistics</h3>
      </div>
    </div>
            ...
            <div class="x_content">
               <table style="width:100%">
                  <tbody>
                     <tr>
                        <th style="width:37%;">
                           <p>Most Common Dental Supplies Used within the Week</p>
                        </th>
            ...
            <div class="x_content">
               <table style="width:100%">
                  <tbody>
                     <tr>
                        <th style="width:37%;">
                           <p>Most Common Dental Supplies Used within the Month</p>
                        </th>
                        <th>
                           <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                              <p>Dental Supply</p>
            ...
            <div class="x_content">
               <table style="width:100%">
                  <tbody>
                     <tr>
                        <th style="width:37%;">
                           <p>Most Common Dental Supplies Used within the Year</p>
                        </th>
                        <th>
                           <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                              <p>Dental Supply</p>
                           ...
                           <div class="tab-pane fade active in" id="tab_content1" role="tabpanel" aria-labelledby="home-tab">
                              <div class="table-responsive">
                                 <table class="table table-striped table-bordered jambo_table bulk_action">
                                    <thead>
                                       <tr class="headings">
                                          <header style="display: inline;" class="col-md-6 col-sm-12 col-xs-12 form-group">Dental Supply</header>
                                          <header style="display: inline;">Number of Dental Supply Used a Day</header>
                                          <th class="column-title" style="width: 20%">Dental Supply Name</th>
                  ...
                  <div class="panel-body">
                     ...
                     <div role="tabpanel" data-example-id="togglable-tabs">
                        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                           ...
                           <li role="presentation">
                              <a id="profile-tab" role="tab" aria-expanded="false" href="#tab_content2" data-toggle="tab">February</a>
                           </li>
                           <li role="presentation">
                              <a id="profile-tab2" role="tab" aria-expanded="false" href="#tab_content3" data-toggle="tab">March</a>
                           </li>
                           <li role="presentation">
                              <a id="profile-tab2" role="tab" aria-expanded="false" href="#tab_content4" data-toggle="tab">April</a>
                           </li>
                           <li role="presentation">
                              ...
                              <div class="table-responsive">
                                 <table class="table table-striped table-bordered jambo_table bulk_action">
                                    <thead>
                                       <tr class="headings">
                                          <header style="display: inline;" class="col-md-6 col-sm-12 col-xs-12 form-group">Dental Supply</header>
                                          <header style="display: inline;">Number of Dental Supply Used a Week</header>
                                          <th class="column-title" style="width: 20%">Dental Supply Name</th>
