            ...
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div>
                    <a target="_blank" href="{{route('dentist.view.dental.certificate', $treatment['treatmentID'])}}" ><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> PRINT</button></a>
