        ...
        <!-- form input mask -->
            ...
            <!--Content-->
                ...
                <div style="margin-top: 25px;margin-bottom: 30px;float: left;text-align:right;width: 100%">
                    <a href="{{ url('/physicianPatientRecord') }}">
                        <button class="btn btn-primary">BACK</button>
                    </a>
                    <a href="">
                        <button class="btn btn-warning">EDIT</button>
                    </a>
                    <a href="{{ url('/physicianPatientDiagnoses') }}">
                        <button class="btn btn-default" style="background-color:#33d9b2; color:white;">CONSULTATIONS</button>
                    </a>
                </div>
