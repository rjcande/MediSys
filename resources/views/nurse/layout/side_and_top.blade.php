    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        <ul class="nav side-menu">
          <li><a href="{{ url('nurse/dashboard') }}"><i class="fa fa-home"></i>Dashboard <span></span></a>
          </li>
          <li><a><i class="fa fa-wheelchair"></i>Patient <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="{{ url('/patient/list')  }}"><i class="fa fa-list-alt"></i>List of Patients</a></li>
              <li><a href="{{ url('/nurse/medical/log') }}"><i class="fa fa-edit"></i>Medical Log</a></li>
            </ul>
          </li>
