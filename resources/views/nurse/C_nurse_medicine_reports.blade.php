                                        ...
                                        <tbody>
                                          ...
                                          @foreach($prescriptions as $prescription)
                                            @foreach($medicines as $medicine)
                                              @if($medicine->medicineID == $prescription->medicineID && $prescription->month == 1)
                                                <tr class="even-pointer">
                                                  <td class=" ">{{ $ctr }}</td>
                                                  <td class=" ">{{ $medicine->genericName }} {{ $medicine->brand }}</td>
                                                  <td class=" ">{{ $prescription->total }}</td>
                                                </tr> 
                                                @php($ctr++)
                                              @endif
                                            @endforeach
                            ...
                            <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="table-responsive">
                                      <table class="table table-striped table-bordered jambo_table bulk_action">
                                        ...
                                        <tbody>
                                          ...
                                          @foreach($prescriptions as $prescription)
                                            @foreach($medicines as $medicine)
                                              @if($medicine->medicineID == $prescription->medicineID && $prescription->month == 8 && $prescription->year == date('Y'))
                                                <tr class="even-pointer">
                                                  <td class=" ">{{ $ctr }}</td>
                                                  <td class=" ">{{ $medicine->genericName }} {{ $medicine->brand }}</td>
                                                  <td class=" ">{{ $prescription->total }}</td>
                              ...
                              <div class="panel">
                                ...
                                <div id="collapseTwentyEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwentyEight">
                                  <div class="panel-body">
                                   <div class="table-responsive">
                                      <caption>Most Prescribed Medicine: <u>{{ $mostPrescribed->genericName }} {{ $mostPrescribed->brand }}</u></caption>
                                      <table class="table table-striped table-bordered jambo_table bulk_action">
                                        <thead>
                                          <tr class="headings">
                                            <th class="column-title">No </th>
