@include('dentist.layout.head')
  <body class="nav-md">
  	<div style="min-width: 1300px; max-width: 1910px; margin: 0 auto;">
    <div class="container body">
      <div class="main_container" style="background-color: #800000">
        @include('dentist.layout.side_and_top')

        <!-- page content -->
        @if(Session::get('accountInfo') && Session::get('accountInfo.position') == 4)
        	@yield('content')
        @else
	        ...
	        <div class="">
	          ...
	          <div class="row">
	            ...
	            <div class="col-md-12 col-sm-12 col-xs-12">
	              <div class="x_panel">
	                  <div class="x_content" style="float: left; width: 100%; text-align: center;">
