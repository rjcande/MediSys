                ...
                <div class="x_content">
                  <!-- Content -->
                    ...
                    <div style="float: right; margin-top:30px;">
                      <a href="{{ route('patientList.viewMore', $patientInfo->patientID) }}"> <button class="btn btn-primary">BACK</button></a>
                    </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="logPatientForm" class="form-horizontal form-label-left" action="{{route('each.log.create')}}" method="get">
          @csrf
